...
class GlobalExceptionHandlerTest {
    ...
    void givenHandleArgumentsTypeMismatchException_ShouldReturnBadRequestStatus() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleArgumentsTypeMismatchException(exception);
    ...
    void givenHandleMissingServletRequestParameterException_ShouldReturnBadRequestStatus() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleMissingServletRequestParameterException(exception);
    ...
    void givenHandleUncaughtException_ShouldReturnInternalServerErrorStatus() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleUncaughtException(exception);
